...
- **Accessibility preferences** — neighboring header toggles independently enable light and high-contrast palettes, saving both preferences in browser local storage for future page loads.
